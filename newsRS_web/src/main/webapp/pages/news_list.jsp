                ...
                <div class="row" >
                        <div class="col-sm-3" style="height: 300px" ng-repeat="entity in list">
                            <div class="thumbnail thumbnail_small">
                                <a href="{{pathJson.projectPath}}news/findOne.do?id={{entity.id}}" class="thumbnail__link">
                                ...
                                <div class="caption thumbnail__caption">
                                    <div class="news caption__news">
                                        ...
                                        <a href="{{pathJson.projectPath}}news/findOne.do?id={{entity.id}}" class="news__link">
